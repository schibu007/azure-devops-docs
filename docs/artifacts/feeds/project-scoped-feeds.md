...
On the upstream project: **Project Settings** > **Permissions** > **Users** > search for your upstream project's name and then select **Expand search** > select your downstream project's build service and allow the following: **View project-level information**.
